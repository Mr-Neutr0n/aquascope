...
def _tool_specs() -> list[ToolSpec]:
    ...
    return [
        ...
        ToolSpec(
            ...
            "flow_duration, baseflow, recession, flood_frequency, signatures, return_periods, spei (precipitation "
            "with a pet_column or temperature_column + latitude), sgi_drought, recharge, aquifer_drawdown. params "
        ...
        ToolSpec(
            ...
            "reliability, irrigation feasibility): the method chain aquascope "
